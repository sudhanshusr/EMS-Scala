CREATE DATABASE  IF NOT EXISTS `slickdemo` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `slickdemo`;
-- MySQL dump 10.13  Distrib 5.6.17, for Win32 (x86)
--
-- Host: localhost    Database: slickdemo
-- ------------------------------------------------------
...
INSERT INTO `person` VALUES (1,'sudhanshu','Kota'),(13,'Abhishek','Indore');
...
GRANT ALL ON slickdemo.* TO 'root'@'%' IDENTIFIED BY 'root';
FLUSH PRIVILEGES;
